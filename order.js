...
let costRes = document.querySelector('.resultCart');
let minus = document.querySelectorAll('.make-order__card-clear');
let cleanOk = document.querySelectorAll('.make-order__clear-text')
